export default ({ getRetrieveWardVisitTotalsGateway }) => async (hospitalId) => {
  const { wards, sortedByTotalVisitsDescending } = await getRetrieveWardVisitTotalsGateway()(hospitalId);
