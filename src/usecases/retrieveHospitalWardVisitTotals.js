export default ({ retrieveHospitalWardVisitTotalsGateway }) => async (hospitalId) => {
  const { wards, sortedByTotalVisitsDescending } = retrieveHospitalWardVisitTotalsGateway()(hospitalId);
