describe("As a trust manager or admin, I want to reset my password if I forget it", () => {
  ...
  const validTrustManagerEmail = "nhs-manager02@nhs.co.uk";
  ...
  it("sends an email with reset password link, when I fill in a valid email", () => {
    ...
    WhenIFillOutTheResetPasswordFormOnTheResetPasswordPage(validTrustManagerEmail);
    AndISubmitTheForm();
    ThenISeeTheResetPasswordSuccessPage(validTrustManagerEmail);
  });
