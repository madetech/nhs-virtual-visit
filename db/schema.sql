...
--
-- Name: scheduled_calls_table; Type: TABLE; Schema: public;
--
...
--
-- Name: scheduled_calls_table_id_seq; Type: SEQUENCE; Schema: public;
--
CREATE SEQUENCE public.scheduled_calls_table_id_seq
    ...
    CACHE 1;
--
-- Name: scheduled_calls_table_id_seq; Type: SEQUENCE OWNED BY; Schema: public;
--
ALTER SEQUENCE public.scheduled_calls_table_id_seq OWNED BY public.scheduled_calls_table.id;
--
-- Name: scheduled_calls_table id; Type: DEFAULT; Schema: public;
--
...
--
-- Name: scheduled_calls_table scheduled_calls_table_pkey; Type: CONSTRAINT; Schema: public;
--
