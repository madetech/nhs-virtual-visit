INSERT INTO trusts (name, admin_code, password, video_) VALUES ('Test Trust', 'admin', crypt('trustpassword', gen_salt('bf', 8)), 'whereby');
INSERT INTO trusts (name, admin_code, password, video_) VALUES ('Test 2 Trust', 'admin2', crypt('trustpassword', gen_salt('bf', 8)), 'jitsi');
